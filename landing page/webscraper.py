...
#ITALIANS data, scraping from the list imported 
...
if ultima_data_salvata == new_data:
    ...
    df = df[['data', 'denominazione_regione', 'totale_positivi', 'nuovi_positivi', 'totale_positivi_test_antigenico_rapido', 'tamponi_test_antigenico_rapido']]    
